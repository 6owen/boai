...
/**
 * AddWorkspaceStep_ConnectRemote - Connect to a remote BoAI Server
 *
 * Two paths:
...
export function AddWorkspaceStep_ConnectRemote({
  ...
  const handleConnect = useCallback(async () => {
    ...
    if (!dataRoot) return
    const defaultBasePath = `${dataRoot}/workspaces`
  ...
  }, [serverUrl, token, dataRoot, isCreateNew, isFreshServer, newWorkspaceName, selectedWorkspace, onCreate, isReconnectMode, onUpdate, reconnectWorkspace])
    ...
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={isReconnectMode
          ...
          : "Connect to a remote BoAI Server for this workspace."}
      />
