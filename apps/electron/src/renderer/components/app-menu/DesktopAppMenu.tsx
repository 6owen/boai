...
import { BoAILogo } from "../icons/BoAILogo"
...
/**
 * Desktop AppMenu — BoAI logo dropdown with Edit/View/Window/Settings/Help/Debug submenus.
 *
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <TopBarButton aria-label={t("menu.craftMenu")}>
          <BoAILogo className="size-5 object-contain" />
        </TopBarButton>
      </DropdownMenuTrigger>
 ...
 * that drive it (`checkForUpdates`, `downloadUpdate`, `toggleDevTools`) all live on
