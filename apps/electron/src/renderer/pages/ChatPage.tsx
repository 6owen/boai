...
const ChatPage = React.memo(function ChatPage({ sessionId }: ChatPageProps) {
  ...
  // BoAI does not yet operate its own public session-viewer service. Keep
  // controls for already-shared legacy sessions, but do not offer new shares.
  const primaryHeaderAction = isCompactMode ? compactInfoButton : (sharedUrl ? shareButton : undefined)
