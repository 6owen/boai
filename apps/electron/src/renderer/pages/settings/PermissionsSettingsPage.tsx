 ...
 * Shows both default patterns (from ~/.boai/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.boai/permissions/default.json.
...
/**
 * Build default permissions data from ~/.boai/permissions/default.json.
