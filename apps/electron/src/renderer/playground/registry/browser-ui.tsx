...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  default: [
    {
      id: 'mock-1',
      url: 'https://localhost:1221/playground.html',
      title: 'localhost',
      favicon: null,
      isLoading: false,
      canGoBack: true,
    ...
    {
      id: 'mock-2',
      url: 'https://linear.app/boai/settings/teams',
      title: 'Linear',
      favicon: null,
      isLoading: true,
      canGoBack: true,
    ...
    {
      id: 'mock-3',
      url: 'https://boai.bamboohr.com/employees/pto/?id=132',
      title: 'BambooHR',
      favicon: null,
      isLoading: false,
      canGoBack: true,
    ...
    {
      id: 'mock-4',
      url: 'https://github.com/6owen/boai',
      title: 'GitHub',
      favicon: null,
      isLoading: false,
      canGoBack: true,
  ...
  'long-names': [
    {
      id: 'long-1',
      url: 'https://www.notion.so/BoAI-Multi-Session-Browser-Registry-Design-Review-Thread-2026-Q1',
      title: 'BoAI Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
    ...
    {
      id: 'long-2',
      url: 'https://linear.app/boai/issue/CHA-999/very-long-title-to-test-truncation-behavior-in-top-bar-badges',
  ...
  'many-running': [
    ...
    {
      id: 'run-2',
      url: 'https://linear.app/boai/team/CHA/active',
    ...
    {
      id: 'run-3',
      url: 'https://github.com/6owen/boai/pulls',
      title: 'GitHub PRs',
      favicon: null,
      isLoading: true,
      canGoBack: false,
    ...
    {
      id: 'run-4',
      url: 'https://boai.bamboohr.com/reports',
  ...
  'stress-mix': [
    ...
    {
      id: 'mix-2',
      url: 'https://linear.app/boai/settings/new-team',
      title: 'Add team',
      favicon: null,
      isLoading: true,
      canGoBack: true,
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/6owen/boai',
      title: 'BoAI OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
