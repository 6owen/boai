 ...
 */
export const messagingGatewayLogPath = join(APP_PATHS.logsDir, 'messaging-gateway.log')
 ...
 */
export const autoUpdateLogPath = join(APP_PATHS.logsDir, 'auto-update.log')
