...
Use `browser_tool` to control built-in browser windows (Chromium) inside BoAI.
...
- Before first browser tool usage, the agent must read this guide (`~/.boai/docs/browser-tools.md`).
