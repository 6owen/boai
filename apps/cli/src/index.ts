#!/usr/bin/env bun
/**
 * craft-cli — Terminal client for a BoAI server.
 *
 * Connects over WebSocket (ws:// or wss://) to a running BoAI server
...
function printHelp(): void {
  process.stdout.write(`craft-cli — Terminal client for BoAI
