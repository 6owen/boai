 ...
 *
 * Watched paths:
 * - ~/.boai/config.json - Main app configuration
 * - ~/.boai/preferences.json - User preferences
 * - ~/.boai/theme.json - App-level theme overrides
 * - ~/.boai/themes/*.json - Preset theme files (app-level)
 * - ~/.boai/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.boai/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.boai/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.boai/permissions/)
