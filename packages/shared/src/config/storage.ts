...
const FALLBACK_CONFIG_DEFAULTS: ConfigDefaults = {
  version: '1.0',
  description: 'Default configuration values for BoAI',
  defaults: {
...
/**
 * Load config defaults from ~/.boai/config-defaults.json
...
export function ensureConfigDir(): void {
  ...
  backupConfigFile();
  // Initialize bundled docs (creates ~/.boai/docs/ with sources.md, agents.md, permissions.md)
  initializeDocs();
...
/**
 * Get the path to the app-level theme override file (~/.boai/theme.json).
 */
 ...
 * Preset themes are stored at ~/.boai/themes/
 */
...
/**
 * Returns the path to the tool-icons directory: ~/.boai/tool-icons/
 */
