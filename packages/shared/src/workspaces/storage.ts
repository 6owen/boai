 ...
 * Default location: ~/.boai/workspaces/
 */
...
const DEFAULT_WORKSPACES_DIR = APP_PATHS.workspacesDir;
...
/**
 * Get the default workspaces directory (~/.boai/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.boai/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.boai/workspaces/
 */
