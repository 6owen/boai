...
export const RPC_CHANNELS = {
  ...
  skills: {
    GET: 'skills:get',
    GET_INVENTORY: 'skills:getInventory',
    GET_FILES: 'skills:getFiles',
    DELETE: 'skills:delete',
    ADOPT: 'skills:adopt',
    STOP_MANAGING: 'skills:stopManaging',
    UPDATE_METADATA: 'skills:updateMetadata',
    PREVIEW_DIRECTORY: 'skills:previewDirectory',
    PREVIEW_NPX: 'skills:previewNpx',
    INSTALL_DIRECTORY: 'skills:installDirectory',
    INSTALL_NPX: 'skills:installNpx',
    REMOVE_MANAGED: 'skills:removeManaged',
    RESTORE: 'skills:restore',
    LIST_OPERATIONS: 'skills:listOperations',
    REFRESH: 'skills:refresh',
    OPEN_EDITOR: 'skills:openEditor',
    OPEN_FINDER: 'skills:openFinder',
    CHANGED: 'skills:changed',
    INVENTORY_CHANGED: 'skills:inventoryChanged',
  },
  statuses: {
    LIST: 'statuses:list',
