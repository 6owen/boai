...
export interface ResolvedBackendRuntimePaths {
  ...
  /** @deprecated Desktop packages no longer resolve or ship a bundled Bun runtime. */
...
export function resolveBackendRuntimePaths(hostRuntime: BackendHostRuntimeContext): ResolvedBackendRuntimePaths {
  return {
    ...
    nodeRuntimePath: hostRuntime.nodeRuntimePath || process.execPath,
    useElectronNode: hostRuntime.isElectron === true && !hostRuntime.nodeRuntimePath,
  };
}
